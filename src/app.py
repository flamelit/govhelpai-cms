...
def render_app():
    ...
    st.markdown(
        ...
        <center><a href="https://flamelit.tech"><img src="app/static/flamelit_logo_large.png" alt="image" width="35%" height="auto"></a>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="https://boostaro.com"><img src="app/static/boostaro_logo.png" alt="image" width="35%" height="auto"></a></center>
         """,
        unsafe_allow_html=True,
    )
